...
import 'package:redofyp/services/time_picker_helper.dart';
import '../../services/ai_chatbot_state.dart';
import '../../widgets/floatingButton.dart';
import '../cart/cart.dart';
import '../../chat/messageDetail.dart';
import '../profile/creatorProfile.dart';
...
class _ViewListingDetailsScreenState extends State<ViewListingDetailsScreen> {
  ...
  String _createConversationId(String senderId, String receiverId) {
    ...
    ids.sort();
    return ids.join('_'); // Use underscore to match your chat service & message detail
  }
                      ...
                      child: AbsorbPointer (
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: 'Service Date and Time',
                            hintText: 'Select date and time for service',
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        if (user != null) {
                          ...
                          // If service time is selected, proceed
                          if (_serviceTimeController.text.isEmpty && _listingData['listingType'] == 'service') {
                            _showErrorDialog("Please select a service time.");  // Error dialog for missing service time
                            return;
                          }
                          ...
                          Map<String, dynamic> cartItem = {
                            ...
                            'status': _listingData['listingType'] == 'service' ? 'Service Available' : 'In Stock',  // Set status
                            'isSelected': false,
                            'listingId': widget.listingId,
                            'serviceTime': _serviceTimeController.text,
                          };

                          // Handle the stock validation only for products
                          if (_listingData['listingType'] == 'product') {
                            ...
                            // If stock is less than the selected quantity, show error dialog
                            if (_quantity > availableQuantity) {
                              setState(() {
                          ...
                          FirebaseFirestore.instance
                            ...
                            if (querySnapshot.docs.isEmpty) {
                              ...
                              // Handle product stock validation before updating cart item quantity
                              if (_listingData['listingType'] == 'product' && cartItemQuantity + _quantity > availableQuantity) {
                                _errorMessage = "Exceeds available stock. Please check your cart.";
                                _showErrorDialog(_errorMessage);  // Show error dialog
                                return;
                              }
                            ...
                            // After adding/updating, navigate to the cart screen
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => CreatorProfileScreen(creatorId: _listingCreatorId),
                      ),
                    );
                  },
                  child: Row(
      ...
      bottomNavigationBar: Container(
        padding: const EdgeInsets.all(8.0),
        decoration: BoxDecoration(
          color: Colors.lightBlue.shade50, // Background color of the bottom bar
        ),
        child: Row(
            ...
            Expanded(
              child: ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  final receiverId = _listingCreatorId;
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => MessageDetailsPage(
                        ...
                        messageContent: '',  // Empty or default initial message
                      ),
                    ),
                  );
                },
