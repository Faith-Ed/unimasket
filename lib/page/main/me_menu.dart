...
import 'package:redofyp/page/profile/profile_page.dart';
...
import 'home.dart';
import '../seller/mySales.dart'; // Make sure you have the HomeScreen route
...
class _MeMenuScreenState extends State<MeMenuScreen> {
  ...
  final AiChatbotState _aiChatbotState = AiChatbotState();
            ...
            children: [
                    ...
                    onTap: () {
                      if (_profileImageUrl != null) {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => ZoomImageScreen(imageUrl: _profileImageUrl!),
                          ),
                        );
                      }
                    },
                    ...
                    ListTile(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PendingOrderScreen(userId: 'userId', orderId: null,),
                          ),
                        );
                      },
                    ),
              ...
              ListTile(
                ...
                trailing: ValueListenableBuilder<bool>(
                  valueListenable: _aiChatbotState.isEnabled,
                  builder: (context, isEnabled, _) {
                    return Switch(
                      value: isEnabled,
                      onChanged: (value) {
                        _aiChatbotState.setEnabled(value);
                      },
                    );
                  },
                ),
