...
import '../chatBot.dart';
import '../listing/create_listing.dart'; // Import CreateListingScreen
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: ClipRRect(
          ...
          child: AppBar(
            toolbarHeight: 90, // Toolbar height remains as per your request
            ...
            flexibleSpace: Stack(
              children: [
                Positioned(
                  left: -20, // Adjust the position of the logo (horizontal)
                  top: -80, // Adjust the position of the logo (vertical overflow)
                  child: Image.asset(
                    'assets/UniMASket2.png', // Your logo path
                    height: 280, // Set logo size to be larger than the AppBar
