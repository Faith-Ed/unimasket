...
class SellerCompleteScreen extends StatefulWidget {
  ...
  const SellerCompleteScreen({Key? key, required this.orderId, required this.userId}) : super(key: key);

  @override
  _SellerCompleteScreenState createState() => _SellerCompleteScreenState();
}
...
class _SellerCompleteScreenState extends State<SellerCompleteScreen> {
  ...
  void initState() {
    ...
    _completedTimestampFuture = FirebaseFirestore.instance
        ...
        .doc('completed_timestamp') // Assuming the document ID for the completed timestamp is 'completed_timestamp'
        .get()
        .then((snapshot) {
      if (snapshot.exists) {
          ...
          children: [
            ...
            if (products.isNotEmpty) ...[
              ...
              Row(
                ...
                children: [
                  Text('Collection Option: ', style: const TextStyle(fontWeight: FontWeight.bold)),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            Text(
              "Completed Time: ${_completedTime?.toDate().toString() ?? 'No Completed Time'}",
